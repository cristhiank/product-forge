...
const messages_1 = __webpack_require__(852);
...
const linkedMap_1 = __webpack_require__(139);
Object.defineProperty(exports, "LinkedMap", ({ enumerable: true, get: function () { return linkedMap_1.LinkedMap; } }));
Object.defineProperty(exports, "LRUCache", ({ enumerable: true, get: function () { return linkedMap_1.LRUCache; } }));
Object.defineProperty(exports, "Touch", ({ enumerable: true, get: function () { return linkedMap_1.Touch; } }));
const disposable_1 = __webpack_require__(46);
Object.defineProperty(exports, "Disposable", ({ enumerable: true, get: function () { return disposable_1.Disposable; } }));
const events_1 = __webpack_require__(677);
...
const sharedArrayCancellation_1 = __webpack_require__(635);
Object.defineProperty(exports, "SharedArraySenderStrategy", ({ enumerable: true, get: function () { return sharedArrayCancellation_1.SharedArraySenderStrategy; } }));
Object.defineProperty(exports, "SharedArrayReceiverStrategy", ({ enumerable: true, get: function () { return sharedArrayCancellation_1.SharedArrayReceiverStrategy; } }));
const messageReader_1 = __webpack_require__(282);
...
const messageBuffer_1 = __webpack_require__(607);
Object.defineProperty(exports, "AbstractMessageBuffer", ({ enumerable: true, get: function () { return messageBuffer_1.AbstractMessageBuffer; } }));
const connection_1 = __webpack_require__(436);
...
const ral_1 = __webpack_require__(877);
...
const Is = __webpack_require__(32);
const events_1 = __webpack_require__(677);
const semaphore_1 = __webpack_require__(788);
var MessageReader;
 ...
 * Licensed under the MIT License. See License.txt in the project root for license information.
 * ----------------------------------------------------------------------------------------- */
const ril_1 = __webpack_require__(276);
// Install the node runtime abstract.
ril_1.default.install();
const path = __webpack_require__(928);
const os = __webpack_require__(857);
const crypto_1 = __webpack_require__(982);
const net_1 = __webpack_require__(278);
const api_1 = __webpack_require__(662);
...
// UNUSED EXPORTS: CopilotSession, approveAll, defineTool
...
var external_node_net_ = __webpack_require__(649);
...
var node = __webpack_require__(836);
;// CONCATENATED MODULE: ./node_modules/@github/copilot-sdk/dist/generated/rpc.js
...
function getBundledCliPath() {
  ...
  const sdkPath = (0,external_node_url_.fileURLToPath)(sdkUrl);
  return (0,external_node_path_.join)((0,external_node_path_.dirname)((0,external_node_path_.dirname)(sdkPath)), "index.js");
}
class CopilotClient {
  cliProcess = null;
  connection = null;
  ...
  async startCLIServer() {
    return new Promise((resolve, reject) => {
      ...
      if (isJsFile) {
        this.cliProcess = (0,external_node_child_process_.spawn)(getNodeExecPath(), [this.options.cliPath, ...args], {
          stdio: stdioConfig,
        ...
        this.cliProcess = (0,external_node_child_process_.spawn)(this.options.cliPath, args, {
          stdio: stdioConfig,
          cwd: this.options.cwd,
          env: envWithoutNodeDebug,
          windowsHide: true
...
stderr: ${stderrOutput}`
  ...
  async connectToParentProcessViaStdio() {
    ...
    this.connection = (0,node.createMessageConnection)(
      new node.StreamMessageReader(process.stdin),
      new node.StreamMessageWriter(process.stdout)
    );
    this.attachConnectionHandlers();
    this.connection.listen();
  }
